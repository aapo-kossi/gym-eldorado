...
class Deck:
    ...
    def discarded_observation(self, n):
        return self.convert_to_obs(self._discard_pile, n)
    ...
    def all_cards_observation(self, n):
        return self.convert_to_obs(self._all_cards, n)
    ...
    def convert_to_obs(cards, max_size):
        obs = np.zeros((max_size, len(CardType)))
