...
from map import Difficulty, Direction, Map, Resource
from player import Player, TurnPhase
import cards
...
class Game:
    ...
    def get_obs(self, agent):
        ...
        obs['deck'] = player.deck.all_cards_observation(MAX_N_DECK)
        obs['discard'] = player.deck.discarded_observation(MAX_N_DECK - MIN_N_HAND)
    ...
    def step(self, action):
        ...
        self.done = self.map.hex_array[loc].is_end and self.selected_player.phase == TurnPhase.INACTIVE
        if self.done:
